 ...
 */
class Redirect404Exception extends RedirectException
{
    ...
    {
        parent::__construct(OW::getRouter()->urlForRoute('base_page_404'), 404);

        if ( !empty($message) )
        {
            OW::getSession()->set('base404RedirectMessage', $message);
        }
    }
}
 ...
 */
class Redirect403Exception extends RedirectException
{
    ...
    public function __construct( $message = null )
    {
        parent::__construct(OW::getRouter()->urlForRoute('base_page_403'), 403);

        if ( !empty($message) )
        {
            OW::getSession()->set('base403RedirectMessage', $message);
        }
    }
}
