...
abstract class OW_BaseDao
{
    ...
    public function findById( $id )
    {
        ...
        return $this->dbo->queryForObject($sql, $this->getDtoClassName(), array((int) $id));
    }
    ...
    public function findListByExample( OW_Example $example )
    {
        if ( $example === null )
        {
    ...
    public function countByExample( OW_Example $example )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
    ...
    public function findObjectByExample( OW_Example $example )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
    ...
    public function deleteById( $id )
    {
        ...
        if ( $id > 0 )
        {
            ...
            return $this->dbo->delete($sql, array($id));
        }
    ...
    public function findIdByExample( OW_Example $example )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
    ...
    public function findIdListByExample( OW_Example $example )
    {
        if ( $example === null )
        {
            throw new InvalidArgumentException('argument must not be null');
