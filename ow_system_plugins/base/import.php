...
class BASE_Import extends DATAIMPORTER_CLASS_Import
{
    ...
    private function importTheme( $importDir )
    {
        ...
        {
            UTIL_File::copyDir($importDir . ($theme->name) . DS, BOL_ThemeService::getInstance()->getRootDir($theme->name));
        }

        UTIL_File::copyDir($importDir . 'themes' . DS, OW_DIR_THEME_USERFILES);
        ...
        BOL_ThemeService::getInstance()->updateCustomCssFile($theme->id);
        BOL_ThemeService::getInstance()->processAllThemes();
    }
