...
class BASE_CTRL_AjaxComponentEntityPanel extends BASE_CTRL_AjaxComponentPanel
{
    ...
    protected function saveSettings( $data )
    {
        ...
        $settings = $this->processSettingList($componentClass, $settings, $data['place'], false);
    ...
    protected function getSettingsMarkup( $data )
    {
        ...
        $cmp = new BASE_CMP_ComponentSettings($componentPlaceUniqName, $componentSettingList, array_merge($defaultSettingList, $entitySettingList));
