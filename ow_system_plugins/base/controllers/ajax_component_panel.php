...
abstract class BASE_CTRL_AjaxComponentPanel extends OW_ActionController
{
    ...
    protected function getComponentSettingList( $componentClassName )
    {
    ...
    protected function getComponentStandardSettingValueList( $componentClassName )
    {
        $this->checkComponentClass($componentClassName);
    ...
    protected function validateComponentSettingList( $componentClassName, $settingList, $place )
    {
        $this->checkComponentClass($componentClassName);
    ...
    protected function processSettingList( $componentClassName, $settingList, $place, $isAdmin )
    {
        $this->checkComponentClass($componentClassName);
