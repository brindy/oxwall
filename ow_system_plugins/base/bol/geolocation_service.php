...
class BOL_GeolocationService
{
    ...
    {
        return BOL_GeolocationIpToCountryDao::getInstance()->ipToCountryCode3($ip);
    }
    ...
    {
        $countryList = BOL_GeolocationCountryDao::getInstance()->findAll();
        $countries = array();
    ...
    {
        return BOL_GeolocationCountryDao::getInstance()->doesTableExist();
    }
