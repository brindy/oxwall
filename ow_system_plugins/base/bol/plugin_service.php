...
class BOL_PluginService
{
    ...
    {
        return $this->pluginDao->findPluginByKey($key);
    }
    ...
    {
        return $this->pluginDao->findActivePlugins();
    }
    ...
    {
        $availPlugins = array();
        $dbPlugins = $this->pluginDao->findAll();
    ...
    {
        $requestUrl = OW::getRequest()->buildUrlQueryString(self::UPDATE_SERVER . 'download-platform', 
            array(
    ...
    {
        return $this->pluginDao->findRegularPlugins();
    }
