...
class ADMIN_CTRL_Users extends ADMIN_CTRL_Abstract
{
    ...
    public function index( array $params )
    {
        ...
        $this->addComponent('userList', new ADMIN_CMP_UserList($type, $extra));
    ...
    public function role( array $params )
    {
        ...
        {
            $extra = array('roleId' => (int) $params['roleId']);
            $this->addComponent('userList', new ADMIN_CMP_UserList('role', $extra));
