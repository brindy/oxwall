...
class UserSettingsForm extends Form
{
    ...
    public function __construct()
    {
        ...
        $this->addElement($avatarSize->setLabel($language->text('admin', 'user_settings_avatar_size')));
        ...
        $this->addElement($bigAvatarSize->setLabel($language->text('admin', 'user_settings_big_avatar_size')));
